...
Quiz: The vertices of the graphs represent the males. Which type of links gives a senseful representation for the sneaking approach?
...
Quiz: Consider the above network. Which of the following statements are true?

- Ruff 1 sneaks into Ruff 2's territory [x]
...
Quiz: Consider now the network of birds from above. Which payoff of the following payoffs is correct, if player $2$ invests in $x_2=2$ units and the other players invest in $x_1$ = $x_3$ units?
...
Quiz: Later we are interested in optimal ways of playing the game. Without any further explanations, do you think a player can improve his payoff by deviating from his current strategy?. If so, which player(s)?

- No one can improve. [ ]

- Player \(1\) can improve. [ ]

- Player \(2\) can improve. [x]

- Player \(3\) can improve. [x]
...
Quiz: Which columns do we need to specify, in order to get exactly the rows of decisions of the $n$ player of a stage game
...
Quiz: With the explanation and the table from above in mind, which statement is true?

- Player A links to player B. [x]

- Player D links to player C. [ ]

- Player A invests in 3 units. [ ]

- Player B invests in 3 units. [x]
...
Quiz: If we just assume, that the evaluating function $f$ is strictly concave, which statement would follow from that?

- The profit per invested unit decreases with an increasing investment level. [x]
...
Quiz: Which statement is true, if player $i$ accesses more than $\hat y$ units and also has a positive investment level, i.e. $x_i>0$?

- He can not improve his payoff. [ ]

- He can improve his payoff by lowering his investment by \(\text{min}\{x_i,|\hat y-y_i| \}\) units. [x]

- He can improve his payoff by lowering his investment by one unit. [x]
...
Quiz: What do you think, are there investment levels which together with the fixed network structure form a NE? If so, which ones?

- There is no NE possible with \(G_0\) as a network. [ ]

- The investment levels \(x_1=x_2=\hat y\) together with \(G_0\) form a NE. [x]
...
- The investment levels \(x_1=0\) and \(x_2=\hat y\) together with \(G_1\) form a NE. [x]
...
- The investment levels \(x_1=x_2=\frac{\hat y}{2}\) together with \(G_2\) form a NE. [x]

- The investment levels \(x_1=\hat y\) and \(x_2=0\) together with \(G_2\) form a NE. [x]

- The investment levels \(x_1=0\) and \(x_2=\hat y\) together with \(G_2\) form a NE. [x]
...
Quiz: Assuming $n = 2$ players and the parameters from the experiment $c = 55$ and $k = 70$, for which network architecture is a Nash Equilibrium possible?
...
Quiz: Is it possible, that $G_3$ arises within a NE? If so, what are the corresponding investments?

- No, it is not possible. [x]
...
Quiz: Is it possible, that $G_4$ arises within a NE? If so, what are the corresponding investments?

- No, it is not possible. [ ]

- Yes, with investment levels of \(x_2 = x_4=\frac{\hat y}{2}\) and \(x_1=x_3=0\). [ ]

- Yes, with investment levels of \(x_4=\hat y\) and \(x_1=x_2=x_3=0\). [x]
...
Quiz: Is it possible, that $G_5$ arises within a NE? If so, what are the corresponding investments?
...
Quiz: Is it possible, that $G_6$ arises within a NE? If so, what are the corresponding investments?

- No, it is not possible. [ ]

- Yes, with investment levels of \(x_2=x_4=\frac{\hat y}{2}\) and \(x_1=x_3=0\). [x]

- Yes, with investment levels of \(x_2=\frac{\hat y}{3}\), \(x_4=\frac{2\hat y}{3}\) and  \(x_1=x_3=0\). [x]
...
Quiz: Is it possible, that $G_7$ arises within a NE? If so, what are the corresponding investments?

- No, it is not possible. [ ]

- It is not possible that \(G_7\) arises within a strict NE. [x]

- Yes, with investment levels of \(x_1 = x_2=x_3=x_4=\hat y\). [ ]

- Yes, with investment levels of \(x_1 = x_2=x_3=x_4=\frac{\hat y}{2}\). [x]
...
Quiz: Which relation about the efficient investment $\widetilde{y}$ can we already deduct?

- \(\widetilde{y}= \hat y\) [ ]

- \(\widetilde{y}\geq \hat y\) [x]
...
Quiz: What happens if we do so?

- The social welfare increases. [ ]

- The social welfare decreases. [ ]

- The payoff of the core player decreases. [x]

- The payoff of the core player increases. [ ]

- The payoff of the periphery players increases. [x]
...
Quiz: What is the efficient investment $\widetilde{y}$ of the core player?
...
Quiz: What is the efficient investment $\widetilde{y}$ of the core player in a star network with $n=8$ players?
...
Quiz: Is the described Nash Equilibrium also a SPNE?
...
Quiz: How many different SPNE's exists where in both rounds only nash stars are played?
...
Quiz: According to the strategy above, which of the network forms, if player $1$ deviates in round one and gets punished and maximizes his payoff in round two?

- The nash star with player one in the core. [ ]

- The efficient star with player two in the core. [ ]

- The nash star with player two in the core. [x]
...
Quiz: For which status rent $b$ it is not worth for the core player $1$ to deviate in the first round?
...
Quiz: Which variable parameters influence the ratio $\frac{\pi_C}{\pi_P}$?

- The evaluating function \(f\). [ ]

- The investment \(x_C\) of the core player. [x]

- The cost \(c\) per unit. [ ]

- The number of players \(n\). [x]

- The status rent \(b\) per incoming link. [x]
...
Quiz: If we consider the two payoffs $\pi_C$ and $\pi_P$, which statement is true? You can use the payoff calculator.

- The core's payoff is bigger, i.e. \(\pi_C > \pi_P\). [x]
...
Quiz: Look at the network from round $t+2$. Player $1$ can either link to player $2$ and get part of the periphery or he can challenge player $2$. Is it worth to challenge player $2$? Assume $t=0$.
...
Quiz: Are the treatments with no status rents, i.e. $b=0$, stable?
...
Quiz: In which number $x_C$ of units can we expect the core to invest in the exolink cases?
...
- \(x_C = \hat y = 2\) (The One Shot NE investment). [x]
...
Quiz: Which specific value of the `star` column do we have to calculate in order to get the relative frequencies of the star networks?
...
Quiz: Before we come to the analysis of the data, I want you to guess, in which two treatments the most efficient outcomes, i.e. 4-stars, arise.
...
Quiz: In which of the following treatments did we predict stable networks to from?
...
Quiz: What do you think, which phenomenon can we observe in the final 25 rounds, compared to the first 25 rounds? There might be more than one right answer.

- The variance of the distributions decreases. [x]

- The competition increases in the treatments without status rents. [ ]

- In nearly all cases of the treatments \(n8b22\) and \(n8b66\), there is one competitor. [x]

- In nearly all cases of the treatments \(n8b22\) and \(n8b66\), there are two competitors. [ ]

- In the treatment \(n8b66\), most of the cases contain one competitor. [x]
